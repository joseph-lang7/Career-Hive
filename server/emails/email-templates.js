...
export function createAcceptedEmailConnectionTemplate(
  senderName,
  recipientName,
  profileUrl
) {
  ...
  <body>
    ...
    <div style="width: 100%; display: flex; justify-content: center">
      <div
        ...
        "
      >
        <h2 style="color: #efb428">Hello ${senderName},</h2>
        <p style="padding-top: 20px; line-height: 21px">
          Great news! ${recipientName} has accepted your friend request on Career Hive.
        </p>
        <div
          style="
            background-color: rgba(202, 191, 191, 0.597);
          ...
          "
        >
          <p style="margin-bottom: 9px">What's next?</p>
          <ul
            style="
              list-style-type: none;
              display: flex;
        ...
        <p style="margin-bottom: 15px">
          Expanding your professional network opens up new opportunities. Keep connecting!
        </p>
        <div style="display: flex; flex-direction: column; gap: 2px">
          <span>Best regards,</span>
          <span>The CareerHive Team</span>
